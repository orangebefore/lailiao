...
import com.quarkso.utils.IdentifyCode;
import com.swetake.util.Qrcode;



public class TwoDimensionCode  extends Controller{

	public static String imgType = "png";//二维码图片格式
	public static int size = 20;//二维码尺寸
	private static String codeType = "utf-8";
	
	//设置二维码中间图片的宽高
	public static int imageWidth = 63;
	public static int imageHeight = 63;
 /** 
...
//            createPhotoAtCenter(bufImg);
    ...
    public static BufferedImage createPhotoAtCenter(BufferedImage bufImg) throws Exception {
    	 Image im = ImageIO.read(new File(config.save_path_root+"image001.png"));
