...
*/
public class UserOld extends Model<UserOld>{

    public static UserOld dao = new UserOld();

    public static final String user_old_id="columnName=user_old_id,remarks=用户ID,dataType=int,defaultValue=null";
    ...
    public static final String sex="columnName=sex,remarks=性别：0-女，1-男,dataType=int,defaultValue=null";

    public static final String taste="columnName=taste,remarks=对谁有兴趣：0-女性，1-男性,dataType=int,defaultValue=null";
