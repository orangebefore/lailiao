package com.quark.buyVerify.ios;
...
public class IOS_Verify {
	...
	public static String getVerifyURL(String receipt){
		if (receipt.equals("Real")) {
			return url_verify;
		}else {
			return url_sandbox;
		}
	 ...
	 * 
	 */
	public static String buyAppVerify(String receipt,String verifyUrl)
	{
