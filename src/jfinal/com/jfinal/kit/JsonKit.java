 ...
 * 
 * Json java string java.lang.String number java.lang.Number true|false
 * java.lang.Boolean null null array java.util.List object java.util.Map
 */
...
public class JsonKit {
	...
	private static String toKeyValue(String key, Object value,
				...
				if (!attrName.equals("Class")) { // Ignore Object.getClass()
					...
					if (types.length == 0) {
						try {
							...
							map.put(StringKit.firstCharToLowerCase(attrName),
									value);
						} catch (Exception e) {
