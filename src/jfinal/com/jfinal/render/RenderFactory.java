...
public class RenderFactory {
	...
	private void initFreeMarkerRender(ServletContext servletContext) {
		try {
			Class.forName("freemarker.template.Template"); // detect
															// freemarker.jar
	 ...
	 * @return
	 */
	public Render getJsonRender(String quote,String[] attrs) {
		return new JsonRender(quote,attrs);
	}
	...
	public Render getErrorRender(int errorCode) {
		return errorRenderFactory.getRender(errorCode,
				constants.getErrorView(errorCode));
	}
	...
	// --------
	private static final class FreeMarkerRenderFactory implements
			IMainRenderFactory {
		public Render getRender(String view) {
			return new FreeMarkerRender(view);
		}
	...
	private static final class ErrorRenderFactory implements
			IErrorRenderFactory {
