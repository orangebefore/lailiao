...
public abstract class JSON implements JSONStreamAware, JSONAware {
     ...
     * @return
     */
    private static final <T> T parseObjectFromRootKey(String text, Class<T> clazz,String key) {
        return parseObject(text, clazz, new Feature[0]);
    }
    /**
     * @author kingsley
     ...
     * @return
     */
    public static final <T> T parseObjectFromRootKey(String text, Class<T> clazz) {
