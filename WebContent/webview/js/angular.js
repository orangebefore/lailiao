/**
 * @license AngularJS v1.3.0-local+sha.ea6fc6e
...
function minErr(module, ErrorConstructor) {
  ...
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-local+sha.ea6fc6e/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-local+sha.ea6fc6e',    // all of these placeholder strings will be replaced by grunt's
